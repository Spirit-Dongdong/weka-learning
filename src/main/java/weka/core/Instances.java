...
public class Instances
  ...
  /** The dataset's name. */
  protected /*@spec_public non_null@*/ String m_RelationName;//数据集名称

  /** The attribute information. */
  protected /*@spec_public non_null@*/ FastVector m_Attributes;//属性信息
  /*  public invariant (\forall int i; 0 <= i && i < m_Attributes.size();
                    m_Attributes.elementAt(i) != null);
  */

  /** The instances. */
  protected /*@spec_public non_null@*/ FastVector m_Instances;//实例

  /** The class attribute's index */
  protected int m_ClassIndex;//索引
